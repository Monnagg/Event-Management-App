...
//    	queryOutput.setText("Show the output of the query here!");
    	...
    	String eventName = evNameT.getText().toString();
    	String eventDate = evDateT.getText().toString();
    	String journalName = jourNameT.getText().toString();
    	
    	A02MiddleTier A2mid = new A02MiddleTier();
    	try {
    		queryOutput.setText(A2mid.insertMethod(sl, eventName, eventDate, journalName));
